 ...
 */
public class PedidosOrdenTrabajo extends javax.swing.JInternalFrame {
...
//            jTable1.setForeground(Color.black);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Vista de Pedidos Para Orden de Trabajo");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            Logger.getLogger(PedidosOrdenTrabajo.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        OrdenTrabajoRegistro.numPedidoOrdenTrabajo();
        dispose();
